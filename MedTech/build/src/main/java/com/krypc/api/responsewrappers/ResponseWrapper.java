package com.krypc.api.responsewrappers;

import org.json.simple.JSONObject;

import com.krypc.api.constants.ErrorConstants;
/**
...
final public class ResponseWrapper {
	 ...
	 * @param code
	 */
	public void setError(ErrorConstants.ERROR_CODES code){
		this.errorCode = code.getErrorCode();
		this.errorMessage = code.getErrorTxt();
